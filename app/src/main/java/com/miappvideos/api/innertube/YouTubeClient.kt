...
/**
 * Clientes InnerTube con sus credenciales reales de YouTube.
...
data class YouTubeClient(
    ...
    fun isWebClient(): Boolean {
        val name = clientName.uppercase(Locale.US)
        return name == "WEB" || name == "WEB_REMIX" || name == "WEB_CREATOR" ||
            name == "MWEB" || name == "WEB_EMBEDDED_PLAYER" || name == "TVHTML5" ||
            name == "TVHTML5_SIMPLY_EMBEDDED_PLAYER" || name == "TVHTML5_SIMPLY"
    }
