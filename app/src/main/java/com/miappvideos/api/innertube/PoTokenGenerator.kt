...
/**
 * Generador de po_token sintetico tipo "cold start" (protobuf).
...
object PoTokenGenerator {
    ...
    fun generateColdStartToken(
        ...
        return Base64.encodeToString(tokenPayload, Base64.URL_SAFE or Base64.NO_PADDING or Base64.NO_WRAP)
    }
